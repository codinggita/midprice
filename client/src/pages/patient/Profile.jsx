  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        <div style={styles.title}>Patient Profile</div>
        <div style={styles.infoRow}>
          <div style={styles.label}>Name</div>
          <div style={styles.value}>{user?.name || 'Guest'}</div>
        </div>
        <div style={styles.infoRow}>
        ...
        <div style={styles.infoRow}>
          ...
          <div style={styles.value} style={{ textTransform: 'capitalize' }}>{user?.role || 'patient'}</div>
        </div>
